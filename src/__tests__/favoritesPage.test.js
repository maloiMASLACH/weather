...
describe('Favorites Page', () => {
  ...
  it('Blocks conteiner', () => {
    const expected = new FavoritesPage().renderFavoritesBlock();
    expect(expected).toBeDefined();
  });
  it('Blocks conteiner', () => {
    const info = { current: { wind_mph: '11', wind_kph: '12', humidity: '13' } };
    const expected = new FavoritesPage().renderShortInfoLine(info);
  ...
  it('Blocks conteiner', () => {
    ...
    const expected = new FavoritesPage().renderCommonInfoBlock(info);
